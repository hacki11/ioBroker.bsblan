...
describe("BSB => convert", () => {
    ...
    it(`VALS should return input value`, async () => {
        const input = "20.5";
        const expected = "20.5";
        expect(bsb.convert(input, 0)).to.be.equal(expected);
    });
    ...
    it(`TIMEPROG should return converted value`, async () => {
        ...
        expect(bsb.convert(input, 9)).to.be.equal(expected);
    });
});